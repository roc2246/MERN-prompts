# react-best-practices-review.prompt.md

## Preferred workflow

If the client supports Agent Skills, use `.agents/skills/mern-react-review/SKILL.md` instead of treating this file as a large standalone system prompt. The skill is the source of truth for this workflow.

## Task

Audit the requested React scope for component design, hooks, state, accessibility, performance, tests, and maintainability.
...
- Load `.agents/skills/mern-react-review/references/project-standards.md` only when repository conventions affect the task.
- For a deep or exhaustive audit, load `.agents/skills/mern-react-review/references/detailed-checklist.md`. Do not load the detailed checklist for a narrow question.
