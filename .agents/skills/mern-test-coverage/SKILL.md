...
description: Audit MERN source files for missing unit tests, propose exact tests, and generate tests using the existing framework when implementation is requested. Use for test coverage audits or missing-test generation.
metadata:
  author: riley-childs
  version: "2.0"
---
...
Deterministic source/test inventory, meaningful behavior coverage, edge cases, framework consistency, and low-value test avoidance.
