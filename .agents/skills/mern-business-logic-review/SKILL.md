...
description: Review MERN service-layer and domain logic for correctness, edge cases, maintainability, and unnecessary runtime validation. Use when reviewing services, utilities, calculations, validators, transformations, or other non-HTTP business logic.
metadata:
  author: riley-childs
  version: "2.0"
---
...
Business rules, edge cases, transformations, trusted internal contracts, and maintainable service/utility design.
